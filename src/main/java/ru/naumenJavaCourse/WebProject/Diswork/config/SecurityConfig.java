...
public class SecurityConfig {
    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests.requestMatchers("/admin/*").hasRole("ADMIN").requestMatchers("/auth/login","/auth/registration","index","/error").permitAll().anyRequest().hasAnyRole("USER","ADMIN"))
